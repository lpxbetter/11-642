...
public abstract class Qryop {
  ...
  protected class DaaTPtr {
    ...
    protected int posIdx = 0;  // Index of the position to examine
    protected String term = null;
    protected double argWgt = 1.0;
  };
  ...
  protected double wgt = 1.0;  // Wright of this operator
  protected boolean isWgtOpt = false;
  /**
  ...
  */
  public void printPtrs(){
	  System.err.println("###Print daatPtrs\ndaatPtrs size:"+ this.daatPtrs.size());
	  
	  for(int i =0; i< this.daatPtrs.size(); i++){
		  DaaTPtr ptri = this.daatPtrs.get(i);
		  System.out.println("ptri argWgt and term: "+ ptri.argWgt +" "+ ptri.term);
	  }
	  System.out.println("###Print daatPtrs end.");
  }
  public void printArgs(){
	  System.err.println("print arg,args size:"+ this.args.size());
	  for(int i =0;i<this.args.size();i++){
		  System.err.println("arg wgt:"+ this.args.get(i).wgt);
		  System.out.println("isWgtOpt:"+ this.args.get(i).isWgtOpt);
	  }
  }
