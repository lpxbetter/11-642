...
public class InvList {
  ...
  public int ctf = 0;
  public int df = 0;
  public String term;// Add by myself
  public String field;
  ...
  public InvList(String termString, String fieldString) throws IOException {
	...
	this.term = new String (termString);
    this.field = new String (fieldString);
    //System.out.println("Invlist :term:"+ term);
  ...
  public void printOneDoc(int docId) {

	  //System.out.println("df:  " + this.df + ", ctf: " + this.ctf);
	  System.out.println("term:  " + this.term + ", field: " + this.field);
  ...
  public void write2File() {
	   ...
	   try {
		   writer = new BufferedWriter(new FileWriter(new File("invList.txt")));
		   writer.write("df:  " + this.df + ", ctf: " + this.ctf + "\n");

	    for (int i = 0; i < this.df; i++) {
	      writer.write("docid:  " + this.postings.elementAt(i).docid + ", tf: "
	          + this.postings.elementAt(i).tf + ", locs: ");

	      for (int j = 0; j < this.postings.elementAt(i).tf; j++) {
	        writer.write(this.postings.elementAt(i).positions.elementAt(j) + " ");
	      }
